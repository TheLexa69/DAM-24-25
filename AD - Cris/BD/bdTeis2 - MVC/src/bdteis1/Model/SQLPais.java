...
public class SQLPais {
    ...
    public void showPaises(Connection connection){
        String id, nome, numHab, nomeCapital, moneda;
        try {
            ...
            while (resultSet.next()) {
                ...
                id = resultSet.getString("idPais");
                nome = resultSet.getString("nombrePais");
                numHab = resultSet.getString("numHabitantes");
                nomeCapital = resultSet.getString("nombreCapital");
                moneda = resultSet.getString("moneda");

                //System.out.println(id + " " + nome + " " + numHab + " " + nomeCapital + " " + moneda);

                System.out.println(msg.showAllPaises(Integer.parseInt(id), nome, Integer.parseInt(numHab), nomeCapital, moneda));
            }
    ...
    public boolean addPais(Connection connection, String nombrePais, int numHabitantes, String nombreCapital, String moneda) {
    ...
    public boolean updatePais(Connection connection, int id, String nombrePais, Integer numHabitantes, String nombreCapital, String moneda) {
    ...
    public boolean deletePais(Connection connection, int idPais) {
